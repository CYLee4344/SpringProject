...
<body>
    ...
    <div id="container">
        <div class="page" id="page1">
            <a href="Best.jsp" class="image_link"><img src="assets/image/2.jpg"></a>
            <div class="text">
                <h1>베스트 +</h1>
            </div>
        ...
        <div class="page" id="page2">
            <a href="New.jsp" class="image_link"><img src="assets/image/10.jpg"></a>
            <div class="text">
                <h1>신상품 +</h1>
            </div>
        ...
        <div class="page" id="page3">
            <a href="Recommend.jsp" class="image_link"><img src="assets/image/4.png"></a>
            <div class="text">
                <h1>추천상품 +</h1>
            </div>
        ...
        <div class="page" id="page4">
            <a href="Best.jsp" class="image_link"><img src="assets/image/5.png"></a>
            <div class="text">
                <h1>베스트 +</h1>
            </div>
        ...
        <div class="page" id="page5">
            <a href="New.jsp" class="image_link"><img src="assets/image/6.jpg"></a>
            <div class="text">
                <h1>신상품 +</h1>
            </div>
        ...
        <div class="page" id="page6">
            ...
            <ul id="first_row">
                ...
                <li>
                    <a href="Store_Info.jsp">매장안내<img src="assets/image/next.png"></a>
                </li>
            </ul>
            <ul id="last_row">
